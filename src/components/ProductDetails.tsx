            ...
            <td className="p-3 text-lg text-gray-800">
                <fetcher.Form method="POST">
                    <button
                        ...
                        name="id"
                        value={product.id}
                        className={`${isAvailable ? 'text-black' : 'text-red-600'}, rounded-lg p-2 text-sm uppercase font-bold w-full border border-black-200 hover:cursor-pointer`}
                    >
                        {isAvailable ? 'En Inventario' : 'Agotado'}
                    </button>
                </fetcher.Form>
